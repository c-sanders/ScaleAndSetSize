...
In order to try and directly invoke from within GIMP, the one and only function that this Plugin defines, i.e. "displayMessage", first start up GIMP and then click;
