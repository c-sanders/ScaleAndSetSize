...
In order to try and get GIMP to directly invoke the one and only function that this Plugin source code file defines, i.e. "displayMessage", first start up GIMP and then click;
...
the presence of the "main" function within this Plugin causes GIMP to try and execute the "gimp_env_init" function again. GIMP realises what is being instructed to
