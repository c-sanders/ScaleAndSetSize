...
This repository is home to a Python Script and an associated GIMP Plugin. Both of them can be used to scale and set the size of an image - and furthermore,
