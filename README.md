...
As part of GIMP's startup routine, it reads in any Plugins which it finds in its Plugin Search path. During this startup routine, it appears though GIMP must execute the "gimp_env_init" function
