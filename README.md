...
As part of GIMP's startup routine, it reads in any Plugins which are in its Plugin Search path. During this startup routine, it must execute the "gimp_env_init" function
